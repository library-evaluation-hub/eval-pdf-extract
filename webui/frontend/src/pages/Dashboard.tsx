...
import { api, type RunInfo, type LeaderboardEntry, type AdapterInfo, METRIC_IDS, METRIC_CATEGORIES } from "../api";
...
export default function Dashboard() {
  ...
  const implementedIds = new Set(adapters.filter((a) => a.implemented).map((a) => a.id));
  const visibleLeaderboard = leaderboard.filter((e) => implementedIds.has(e.adapter_id));
